    ...
    <header className="bg-white shadow-sm sticky top-0 z-50">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          {/* Navegación (oculta en móviles, visible en desktop) */}
          ...
          {/* Botones de CTA (puedes personalizarlos) */}
          <div className="hidden md:flex items-center space-x-2"> {/* Añadido space-x-2 para separar botones */}
            <a // Botón de WhatsApp
              href="https://chat.whatsapp.com/IE2jbFhHHoIAQccgxmGkQG" // Enlace al chat de WhatsApp
              target="_blank"
              rel="noopener noreferrer"
              className="px-3 py-1.5 bg-green-600 text-white rounded-md hover:bg-green-700 transition-colors duration-200 text-sm flex items-center" // Estilo similar al botón de suscripción, pero en verde
            >
              {/* Icono de WhatsApp (opcional, puedes usar un SVG o un emoji) */}
            ...
            <a // Botón de Suscribirse (original)
        ...
        {/* Menú móvil desplegable (solo visible en móviles cuando isMenuOpen es true) */}
        {isMenuOpen && (
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white shadow-lg rounded-md">
              ...
              {/* Botones de CTA en móvil */}
              <div className="px-3 pt-2 pb-2 space-y-2">
                <a
                  href="https://chat.whatsapp.com/IE2jbFhHHoIAQccgxmGkQG" // Enlace al chat de WhatsApp
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full text-center px-4 py-2 bg-green-600 text-white rounded-md hover:bg-green-700 transition-colors duration-200 block flex items-center justify-center" // Estilo similar, centrado, con icono
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full text-center px-4 py-2 bg-amber-600 text-white rounded-md hover:bg-amber-700 transition-colors duration-200 block"
                >
                  Suscríbete
                </a>
              </div>
